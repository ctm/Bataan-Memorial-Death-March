...
|Date|Miles|Pace|Pounds|Where|Notes|
|----|-----|----|------|-----|-----|
|Dec 25|5.6|interval|40|from house|_will not do, due to chafing[^10]_|
...
|Feb 5|15.5|interval|40|from house||
...
ridiculously slowly.
[^10]: The scab on my back needs additional time to heal, and I also want to
run the southern half of the Foothils 50k course to capture a clean GPX file.
